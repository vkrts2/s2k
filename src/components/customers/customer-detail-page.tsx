...
import { PlusCircle, Trash2, Pencil, Printer } from 'lucide-react';
      ...
      <Card className="mb-6">
        <CardHeader className="flex flex-row items-start justify-between">
          ...
          <div className="flex space-x-2">
             ...
             <Button variant="secondary" onClick={() => setShowPrintView(true)}><Printer className="mr-2 h-4 w-4" /> Yazdır</Button>
          </div>
        </CardHeader>
        <CardContent>
