...
import { getFileFromDB, storeFileInDB, deleteFileFromDB } from '@/lib/indexedDBStorage'; // IndexedDB'den dosya getirme fonksiyonu
    ...
    try {
      ...
      if (fileBlob) {
        ...
        toast({
          ...
          description: `${fileName} adlı dosya indirilmeye başlandı.`,
        });
      } else {
        toast({
          title: "Hata",
